...
function getCatppuccinColors(isDark: boolean, accentKey: string = 'mauve'): AccentColors {
...
function generateSystemColors(materialColors: any, isDark: boolean): AccentColors {
  return {
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const material3Result = useMaterial3Theme ? useMaterial3Theme({
  ...
  return (
    <ThemeContext.Provider value={{ colors, settings, updateSettings, refreshTheme }}>
      {children}
