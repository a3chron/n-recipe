  ...
  return (
    ...
    >
      ...
      >
        ...
        {isSelected && <Check size={20} color={accentColors.primary} />}
      </ThemedView>
    </TouchableOpacity>
  );
}
...
function CatppuccinColorOption({
  name,
  colorKey,
  colorValue,
  isSelected,
  ...
  return (
    ...
    >
      ...
      {/* Selection Check */}
      {isSelected && <Check size={16} color={accentColors.primary} />}
    </TouchableOpacity>
  );
}
...
export default function AppearanceSettingsScreen() {
  ...
  const handleCatppuccinAccentSelect = async (accentKey: string) => {
    try {
      ...
      Alert.alert(
        "Accent Updated",
        "Catppuccin accent color updated successfully.",
      );
    } catch (error) {
          ...
          >
            ...
            >
              ...
              <ThemedText style={{ color: accentColors.subtext1 }}>
                This is how recipe cards will look with your selected theme and
                accent color.
              </ThemedText>
            </ThemedView>
          </ThemedView>
